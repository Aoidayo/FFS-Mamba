...
class MambaCrossAttn(nn.Module):
    def __init__(self, config, road_gat_data):
        ...
        road_gat_data
        '''
        super(MambaCrossAttn, self).__init__()
        ...
        if self.pretrain_mamba_road_view_ckpt_path is not None:
    ...
    def forward(
        ...
        return road_pooled, gps_mean_pooled # (B,D), (B,D)
