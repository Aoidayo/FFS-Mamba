config = {
    ...
    # -- main args
    "task":"ffs_downstream",
    "model": "FFSTTE_CrossAttn",
    "dataset": "chengdu",
    "config_file": "tte_crossattn",
    "saved_model": True, # executor 参数
    "train": True,
    "device": None,

    # -- pretrain
    "pretrain_mamba_road_view_ckpt": None,
    "pretrain_mamba_gps_view_ckpt": None,
    ...
    # -- dataset
    "dataset_class": "FFSTTE_CrossAttn_Dataset",
    "batch_size": 64,
    "num_workers": 0,
    "seq_len": 128, # 不使用
    ...
    # -- executor
    "executor": "FFSTTE_CrossAttn_Executor",
    "learner": "adamw",
