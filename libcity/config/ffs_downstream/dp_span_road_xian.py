config = {
    ...
    # -- pretrain
    "pretrain_mamba_road_view_ckpt": None, # "./libcity/cache/pm/star/936121/model_cache/936121_MambaRoadViewRoadGM_chengdu.pt",
    "pretrain_mamba_gps_view_ckpt": None, # "./libcity/cache/ffs/249937/model_cache/MambaFuseAugView_chengdu_epoch8.tar",
    # "pretrain_mamba_ckpt": "./libcity/cache/ffs/764162/model_cache/MambaMlmGpsRoadContra_chengdu_epoch6.tar",
    # "initial_ckpt": "./libcity/cache/ffs/843509/model_cache/843509_FFSTTE_AUG_chengdu.pt",
    # "pretrain_mamba_ckpt": None, # "./libcity/cache/ffs/845722/model_cache/MambaDp_chengdu_epoch10.tar", # None, # "./libcity/cache/ffs/124339/model_cache/MambaMlmGpsRoadContra_chengdu_epoch6.tar", # "./libcity/cache/ffs/74810/model_cache/MambaMlmGpsRoadContra_chengdu_epoch29.tar",
    # "pretrain_mamba_ckpt": None, # "./libcity/cache/ffs/845722/model_cache/MambaDp_chengdu_epoch10.tar", # None, # "./libcity/cache/ffs/124339/model_cache/MambaMlmGpsRoadContra_chengdu_epoch6.tar", # "./libcity/cache/ffs/74810/model_cache/MambaMlmGpsRoadContra_chengdu_epoch29.tar",
    # "pretrain_mamba_ckpt": "./libcity/cache/ffs/799280/model_cache/MambaDp_chengdu_epoch10.tar",
    ...
    "cache_gps_traj_road_list_path": "/aoi/raw_data/xian_cache/gps_traj_road_list.pkl",


    # -- dataset
    "dataset_class": "FFSDP_Span_Dataset",
    "batch_size": 64,
    "num_workers": 0,
    "seq_len": 128, # 不使用
    ...
    "roadgm_gat_num_heads_per_layer": [8, 4, 1],
    ...
    # -- executor
    "executor": "FFSDP_Span_Road_Executor",
    "learner": "adamw",
    ...
    # -- -- road FFSDP_Evaluator ["Precision", "Recall", "Accuracy", "F1", "MRR", "MAP", "NDCG"]
    "evaluator": "FFSDP_Evaluator",
    # "metrics": ["Precision", "Recall", "Accuracy", "F1", "MRR", "MAP", "NDCG"],
    "metrics": ['Precision', 'Recall', 'F1', 'MRR', 'MAP', 'NDCG',
                                'Acc', 'MacroF1', 'MacroRecall', 'Acc@k'],
    "save_modes": ["csv", "json"],
    "topk": [1, 5, 10],
