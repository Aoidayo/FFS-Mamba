config = {
    ...
    "model": "FFSTTE_AUG",
    "dataset": "chengdu",
    "config_file": "chengdu_small_4_gpsview_in_tte_aug",
    ...
    "pretrain_mamba_gps_view_ckpt": "./libcity/cache/ffs/350231/model_cache/350231_MambaFuseAugView_chengdu.pt",
    ...
    "lr_momentum":0,
    "grad_accmu_steps": 1,
    "test_every": 5, # 多少个epoch evaluate测试一次
