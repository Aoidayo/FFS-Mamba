config = {
    ...
    "pretrain_mamba_ckpt": "./libcity/cache/ffs/124339/model_cache/MambaMlmGpsRoadContra_chengdu_epoch6.tar", # "./libcity/cache/ffs/74810/model_cache/MambaMlmGpsRoadContra_chengdu_epoch29.tar",
    ...
    "metrics": ["Precision", "Recall", "F1", "MRR", "NDCG"], # , "MAPE", "R2", "EVAR"
    "save_modes": ["csv", "json"],
    "topk": [1, 5, 10],
