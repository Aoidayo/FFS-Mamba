...
config = {
    ...
    # -- dataset
    "dataset_class": "MambaRoadViewDataset",
    "batch_size": 64,
    "num_workers": 0,
    "seq_len": 128, # 不使用
    ...
    "masking_ratio": 0.85,
    "avg_mask_len": 2,
    "masking_mode": "geometric",
    "distribution": "random", # geometric | random | interval
    ...
    # -- executor
    "executor": "MambaRoadViewExecutor",
    "learner": "adamw",
    "learning_rate": 1e-3, # 1e-3 / 2e-4
    "weight_decay": 0.01,
    "lr_beta1": 0.9,
    "lr_beta2": 0.999,
    "lr_alpha": 0.99,
