config = {
    ...
    "model": "MambaFuseView",
    "dataset": "chengdu",
    "config_file": "chengdu_small",
    "saved_model": True, # executor 参数
    "train": True,
    "device": None,

    # -- pretrain
    "pretrain_mamba_road_view_ckpt": "./MambaRoadView_chengdu.tar",
    ...
    # -- dataset
    "dataset_class": "MambaFuseViewDataset",
    "batch_size": 16,
    "num_workers": 0,
    "seq_len": 128, # 不使用
    ...
    # -- executor
    "executor": "MambaFuseViewExecutor",
    "learner": "adamw",
    ...
    "lr_momentum":0,
    "grad_accmu_steps": 1,
    "test_every": 50, # 多少个epoch evaluate测试一次
